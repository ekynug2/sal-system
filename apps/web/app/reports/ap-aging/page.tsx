...
import { useAPAging } from '@/hooks/use-reports';
...
export default function APAgingPage() {
    ...
    const { data: reports, isLoading, refetch, isFetching } = useAPAging({ asOf });
        ...
        <div className="app-layout">
            ...
            <main className="main-content">
                <div className="page-header print:hidden">
                    <h1 className="page-title">Umur Hutang (AP)</h1>
                ...
                <div className="card_p4 print:shadow-none print:border-none" style={{ padding: '32px', minHeight: '500px' }}>
                    ...
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold">RINGKASAN UMUR HUTANG</h2>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center p-12 text-gray-500">Tidak ada tagihan yang belum dibayar ditemukan</div>
                    ) : (
                        <div style={{ overflowX: 'auto' }}>
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody>
                                    {reports.map((report) => (
                                        <tr key={report.supplierId} className="bg-white border-b hover:bg-gray-50">
                                            <td className="px-4 py-3 font-medium text-gray-900">
                                                <Link href={`/suppliers/${report.supplierId}`} className="hover:underline text-primary-600">
                                                    {report.supplierName}
                                                </Link>
                                                <div className="text-xs text-gray-500">{report.supplierCode}</div>
                                            </td>
