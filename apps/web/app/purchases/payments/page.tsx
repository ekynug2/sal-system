...
// =============================================================================
// SAL Accounting System - Purchase Payments Page
// =============================================================================
...
export default function PurchasePaymentsPage() {
    ...
    const { data, isLoading, error } = usePurchasePayments({ page, limit: 20, search });
    ...
    if (!user.permissions.includes(Permissions.PURCHASE_PAYMENT_VIEW)) {
        return (
